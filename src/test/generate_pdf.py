...
def create_dummy_pdf(filename):
    ...
    elements.append(t1)
    # The table is at the end of the page, so ends_with_table should be True.
    # We will force a page break.
    elements.append(PageBreak())
    
    # Page 2: Starts with the continued table
    data2 = [
        ["Header 1", "Header 2", "Header 3"],
        ["(Continued)", "", ""],  # This row should merge with the last row of previous table
...
create_dummy_pdf("test_sample.pdf")